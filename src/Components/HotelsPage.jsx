...
const HotelsPage = () => {
  ...
  const location = useLocation();
      ...
      try {
        let response = await fetch(`https://cors-anywhere.herokuapp.com/https://sandbox.impala.travel/v1/hotels?country[eq]=${theCountryCode}&name[like]=${name === '' ? '[SANDBOX]' : name}`, {
          method: 'GET',
          headers: {

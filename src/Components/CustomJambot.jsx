        ...
        <Jumbotron fluid className='navbarWidth jambPic pt-0' style={{borderRadius:'20px'}}>
            ...
            <Container>
                <div className='formInput shadow-lg'>
                    <h6 className='border-bottom pb-3 pt-3 text-center  smallHeader'>More About Us</h6>
                    <p>Here we provide you the available hotels and the weather temperature of your desired city.</p>
                    ...
                    <img src="small-6.jpg" alt=""  className='radius smallPicDisapear'/>
                </div>
            </Container>
        </Jumbotron>
    )

        ...
        <Container fluid  className="">
            <Row className="">
              ...
              <div className="firstPicSide d-flex align-items-center justify-content-center text-white text-left">
                ...
                <h5>If you intrested you can have a look at my second project by clicking <a href="http://13.41.230.212:443/" rel="noreferrer" target="_blank" style={{textDecoration:"none",color:"white"}}><b>Here.</b><div className=""></div></a></h5></span>
              </div>
                </Col>
            </Row>
        </Container>
